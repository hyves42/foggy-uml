    ...
    U: Debug,
{
    ...
    pub fn set(&mut self, id: U, t: T) -> Result<U, String> {
        let idx = GuidManager::guid_id(id) as usize;
    ...
    pub fn iter(&self) -> UidStoreIterator<T, U> {
...
impl<'a, T, U> UidStoreIterator<'a, T, U> {
    pub fn new(store: &'a UidStore<T, U>) -> Self {
        UidStoreIterator { store, id: None }
    }
}
